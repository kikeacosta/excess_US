...
# looking at the average proportion among missing ages in other periods,
# for the same State and Sex
...
write_rds(db_20m6, "Output/weekly_deaths_by_state_sex_age_2020_2021.rds")
